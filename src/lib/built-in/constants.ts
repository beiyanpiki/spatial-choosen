import type { PreprocessCropAssetScale, PreprocessImageKind, PreprocessStepId } from "../../types/built-in";
...
export const PREPROCESS_DERIVED_IMAGE_STORE = "builtin-derived-images";
