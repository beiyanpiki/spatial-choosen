...
import { normalizeProjectForWorkspace } from '@/app/built-in/projectState';
import type { LegacyPreprocessProject, ProjectedSpot, TissueActivationValue } from '@/types/built-in';
