...
} from '@/app/built-in/projectState';
import type { PreprocessProject, ProjectedSpot, TissueActivationValue } from '@/types/built-in';

import { deserializePreprocessImport, deserializePreprocessProject, PACKAGE_VERSION } from '@/lib/built-in/package';
