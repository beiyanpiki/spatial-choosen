...
const fiftyUmDirectory = path.resolve(process.cwd(), 'public/built-in-admin-chip-configs/50um');
const fifteenUmDirectory = path.resolve(process.cwd(), 'public/built-in-admin-chip-configs/15um');
